...
class WDIOCLInterface extends _events.default {
  ...
  onTestError(payload) {
    let error = {
      type: 'Error',
      message: typeof payload.error === 'string' ? payload.error : 'Uknown error.'
    };
  ...
  printSummary() {
    ...
    return this.log('\nSpec Files:\t', _chalk.default.green(this.result.passed, 'passed') + ', ' + retries + failed + totalJobs, 'total', `(${percentCompleted}% completed)`, 'in', elapsed, '\n');
  }
